...
import co.syberia.launcher.SyberiaLauncher;
import co.syberia.launcher.SyberiaLauncherModelDelegate;
...
public class SmartspaceViewContainer extends FrameLayout implements PluginListener<BcSmartspaceDataPlugin> {
    ...
    public SmartspaceViewContainer(Context context, AttributeSet attributeSet) {
        ...
        SyberiaLauncher launcher = (SyberiaLauncher) ActivityContext.lookupContext(context);
        launcher.getLauncherUnlockAnimationController().setSmartspaceView(mView);

        SyberiaLauncherModelDelegate delegate = (SyberiaLauncherModelDelegate) launcher.getModel().getModelDelegate();
    ...
    public void onPluginDisconnected(BcSmartspaceDataPlugin plugin) {
        SyberiaLauncher launcher = (SyberiaLauncher) ActivityContext.lookupContext(getContext());
